...
1)	You are required to create tables for supplier,customer,category,product,supplier_pricing,order,rating 
...
-- supplier, customer, category, product, supplier_pricing, order, rating 
...
$$ DELIMITER ;
*/
call `order-directory`.ratingprocedure();
